...
@Component({
  selector: 'app-series-loop-simulator',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './series-loop-simulator.component.html',
  styleUrls: ['./series-loop-simulator.component.css']
})
export class SeriesLoopSimulatorComponent implements OnInit, OnDestroy {

  // ----- Slider-bound values -----
  vSource = 12;     // Source Voltage (V)
  r1 = 10;          // Resistor 1 (Ω)
  r2 = 15;          // Resistor 2 (Ω)
  r3 = 20;          // Resistor 3 (Ω)
